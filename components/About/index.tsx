    ...
    <div className={styles.container}>
      ...
      <div>
        <div>
          ...
          it. To put it simply, it’s the realization that this is all we’ve got.
        </div>
        <br></br>
        <div>
          At Overview, we are driven by this concept, investing in companies
          that are creating solutions to address climate change. Our mission is
          to support and partner with entrepreneurs who can unlock innovations
          that have the potential to transform industries and make our future
          more resilient and equitable for generations to come.
        </div>
      </div>
    </div>
  );
